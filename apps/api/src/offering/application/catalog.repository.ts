...
export interface CatalogRepository {
  listDanceTypes(status?: CatalogStatus): Promise<DanceType[]>;
  findDanceType(id: string): Promise<DanceType | null>;
  findDanceTypeByNormalizedName(name: string): Promise<DanceType | null>;
  createDanceType(data: Omit<DanceType, 'id' | 'createdAt' | 'updatedAt'>): Promise<DanceType>;
  updateDanceType(
    id: string,
  ...
  createRoom(data: Omit<Room, 'id' | 'createdAt' | 'updatedAt'>): Promise<RoomWithBranch>;
  updateRoom(
    id: string,
