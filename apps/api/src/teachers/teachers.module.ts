...
@Module({ imports: [DatabaseModule], controllers: [TeachersController], providers: [TeachersService, PrismaTeacherRepository, { provide: TEACHER_REPOSITORY, useExisting: PrismaTeacherRepository }] })
